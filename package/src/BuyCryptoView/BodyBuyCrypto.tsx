...
import InputButtonFiat from "../common/Input/InputButtonFiat";
    ...
    return (
        <main className={stylesCommon.body}>
            ...
            <div className={`${stylesCommon.body__child} ${stylesCommon['row-fields']}`}>
                ...
                <InputButtonFiat onClick={openPickCurrency} className={stylesCommon['row-fields__child']} label="Currency" selectedOption={selectedCurrency.name} icon={selectedCurrency.icon} />
            </div>
